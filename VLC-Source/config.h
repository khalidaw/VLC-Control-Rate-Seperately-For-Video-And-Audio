...
#define PACKAGE_STRING "vlc 2.2.3"
...
#define PACKAGE_VERSION_REVISION 3
...
#define VERSION_MESSAGE "2.2.3 Weatherwax"

/* compiler */
#define VLC_COMPILER "gcc version 5.2.1 20151010 (Ubuntu 5.2.1-22ubuntu2)"

/* user who ran configure */
#define VLC_COMPILE_BY "vlc"

/* host which ran configure */
#define VLC_COMPILE_HOST "VLC-ubuntu15-ssd"
